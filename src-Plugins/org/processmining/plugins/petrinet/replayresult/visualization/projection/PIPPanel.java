 ...
 *
 */
public class PIPPanel extends JPanel implements MouseListener, MouseMotionListener {
	...
	private final PNLogReplayProjectedVisPanel view;


	public PIPPanel(PNLogReplayProjectedVisPanel view) {

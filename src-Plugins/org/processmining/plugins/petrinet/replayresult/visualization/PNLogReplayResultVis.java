 ...
 * @since Dec 30, 2010
 */
@Plugin(name = "View Projection to Log", returnLabels = { "Visualized Log-Model Alignment Projection to Log" }, returnTypes = { JComponent.class }, parameterLabels = { "Log-Model alignment" }, userAccessible = false)
@Visualizer
public class PNLogReplayResultVis {
	...
	public JComponent visualize(PluginContext context, PNRepResult logReplayResult) {
		...
		return new PNLogReplayResultVisPanel(net, log, logReplayResult, context.getProgress());
	}
}

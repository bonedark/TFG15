...
public class ExportPNRepResult {
	// whole stats
	...
	public void exportRepResult2File(UIPluginContext context, PNRepResult net, File file) throws IOException {
		exportToFile(context, net, file);
	}

	private void exportToFile(UIPluginContext context, PNRepResult repResult, File file) throws IOException {
		System.gc();

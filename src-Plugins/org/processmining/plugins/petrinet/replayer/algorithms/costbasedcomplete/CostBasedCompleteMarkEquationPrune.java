 ...
 *
 */
public class CostBasedCompleteMarkEquationPrune  extends AbstractCostBasedCompleteMarkEqAlg {
	public String toString() {
		return "A* Cost-based Fitness (with marking equation analysis, require final marking)";
	}
	...
	public String getHTMLInfo() {
		return "<html>This is an algorithm to calculate cost-based fitness between a log and a Petri net. <br/><br/>"
				...
				+ "calculate which transition needs to fire to reach proper termination. Moreover, it prunes visited "
				+ "states/equally visited states.<br/><br/>"

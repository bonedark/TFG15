 ...
 *
 */
public class CostBasedCompleteRPSTPrune extends AbstractCostBasedCompleteRPSTAlg {

	public String toString() {
		return "A* Cost-based Fitness (with RPST analysis optimization)";
	}
	...
	public String getHTMLInfo() {
		return "<html>This is an algorithm to calculate cost-based fitness between a log and a Petri net. <br/><br/>"
				...
				+ "calculate which transition needs to fire to reach proper termination AND prune visited states/equally "
				+ "visited states. <br/><br/>" + "Cost for skipping (move on model) and inserting (move on log) "

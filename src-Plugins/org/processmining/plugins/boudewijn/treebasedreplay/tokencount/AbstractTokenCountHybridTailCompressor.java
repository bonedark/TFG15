...
public abstract class AbstractTokenCountHybridTailCompressor<T extends Tail> extends AbstractCompressor<T> {

	protected final short activities;
	protected int nodeMaskSize;
	protected final int activityBytes;

	public AbstractTokenCountHybridTailCompressor(short nodes, short activities, short leafs) {

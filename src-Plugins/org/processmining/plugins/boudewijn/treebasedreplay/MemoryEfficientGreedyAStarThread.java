...
public class MemoryEfficientGreedyAStarThread<H extends Head, T extends Tail> extends AbstractGreedyAStarThread<H, T> {

	protected final CompressedStore<State<H, T>> store;
	private final CompressedHashSet<State<H, T>> statespace;

	public MemoryEfficientGreedyAStarThread(MemoryEfficientAStarAlgorithm<H, T> algorithm, H initialHead,

 ...
 * 
 * @param <T>
 *            The type of evolvable entity that can be evaluated.
 * @author Daniel Dyer
 */
public interface FitnessEvaluator<T> {
	/**
	 * Calculates a fitness score for the given candidate. Whether a higher
	 * score indicates a fitter candidate or not depends on whether the fitness
	 * scores are natural (see {@link #isNatural}). This method must always
	 * return a value greater than or equal to zero. Framework behaviour is
	 * undefined for negative fitness scores.
	 * 
	 * @param candidate
	 *            The candidate solution to calculate fitness for.
	 * @param population
	 ...
	 *            member of the population is the specified candidate.
	 * @return The fitness score for the specified candidate. Must always be a
	 *         non-negative value regardless of natural or non-natural
	...
	/**
	 * <p>
	 * Specifies whether this evaluator generates <i>natural</i> fitness scores
	 * or not.
	 * </p>
	 * <p>
	 ...
	 * </p>
	 * <p>
	 * In contrast, <i>non-natural</i> fitness evaluation results in fitter
	 ...
	 * </p>
	 * <p>
	 * The terminology of <i>natural</i> and <i>non-natural</i> fitness scores
	 * is introduced by the Watchmaker Framework to describe the two types of
	 * fitness scoring that exist within the framework. It does not correspond
	 * to either <i>standardised fitness</i> or <i>normalised fitness</i> in the
	 * EA literature. Standardised fitness evaluation generates non-natural
	 ...
	 * </p>
	 * 
	 * @return True if a high fitness score means a fitter candidate or false if

...
public class SocialNetworkAnalysisUI extends JPanel implements ActionListener {
	...
	public SocialNetworkAnalysisUI(PluginContext context, SocialNetwork sn) {
		this.sn = sn;
		try {
			// Initialize Graph
			initGraph();
	...
	private void initGraph() {
		...
		vv = new VisualizationViewer<SNNode, SNEdge>(layout, new Dimension(600, 600));
